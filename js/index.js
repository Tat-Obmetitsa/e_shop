...
/* harmony import */ var _templates_arrivalsGallery_hbs__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_templates_arrivalsGallery_hbs__WEBPACK_IMPORTED_MODULE_11__);
      ...
      (function () {
        ...
        featuredBtn.addEventListener('click', function () {
          return window.location.href = "http://github.com/Tat-Obmetitsa/e_shop/productList.html?=featured";
        });
        arrivalsBtn.addEventListener('click', function () {
          return window.location.href = "http://github.com/Tat-Obmetitsa/e_shop/productList.html?=arrivals";
        });
        popularBtn.addEventListener('click', function () {
          return window.location.href = "http://github.com/Tat-Obmetitsa/e_shop/productList.html?=popular";
        });
        bannerBtn.addEventListener('click', function () {
          return window.location.href = "http://github.com/Tat-Obmetitsa/e_shop/productList.html";
        });
        categoriesBtns[0].addEventListener('click', function () {
          return window.location.href = "http://github.com/Tat-Obmetitsa/e_shop/productList.html?=jacket";
        });
        categoriesBtns[1].addEventListener('click', function () {
          return window.location.href = "http://github.com/Tat-Obmetitsa/e_shop/productList.html?=shirt";
        });
        categoriesBtns[2].addEventListener('click', function () {
          return window.location.href = "http://github.com/Tat-Obmetitsa/e_shop/productList.html?=jeans";
        });
        categoriesBtns[3].addEventListener('click', function () {
          return window.location.href = "http://github.com/Tat-Obmetitsa/e_shop/productList.html?=shoes";
        });
        categoriesBtns[4].addEventListener('click', function () {
          return window.location.href = "http://github.com/Tat-Obmetitsa/e_shop/productList.html?=dress";
        });
        categoriesBtns[5].addEventListener('click', function () {
          return window.location.href = "http://github.com/Tat-Obmetitsa/e_shop/productList.html?=fashion";
        });
          ...
          el.addEventListener('click', function () {
            input.forEach(function (e) {
              e.addEventListener('keyup', function (ev) {
                ...
                if (e.value !== '') {
                  el.onclick = function () {
                    window.location.href = "http://github.com/Tat-Obmetitsa/e_shop/productList.html?=".concat(e.value);
                  };
                }
              });
