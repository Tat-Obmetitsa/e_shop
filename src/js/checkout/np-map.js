...
let mapOffices, infoWindow, marker
function initMapPost(places) {
      mapOffices = new google.maps.Map(document.getElementById("map-offices"), mapOptions);
 ...
 function addPlaces(places, map) {
    ...
    for (const place of places) {
        ...
        li.addEventListener("click", () => {
            ...
            document.querySelector(".office-num").value = place.address
            document.querySelector(".office-type").value = place.description.split(":")[0]
        });
